...
RUN wget https://github.com/Kitware/CMake/releases/download/v3.24.0/cmake-3.25.0.tar.gz && tar zxvf cmake-3.24.0.tar.gz
RUN cd /opt/cmake-3.24.0 && ./bootstrap && make && make install
